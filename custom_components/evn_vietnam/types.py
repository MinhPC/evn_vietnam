...
EVN_SENSORS: tuple[EVNSensorEntityDescription, ...] = (
    ...
    EVNSensorEntityDescription(
        ...
        value_fn=lambda data: data.get(ID_ECON_DAILY_NEW),
        dynamic_name=True,
    ),
    EVNSensorEntityDescription(
        ...
        value_fn=lambda data: data.get(ID_ECOST_DAILY_NEW),
        dynamic_name=True,
    ),
    # Previous day
    EVNSensorEntityDescription(
        ...
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        value_fn=lambda data: data.get(ID_ECON_DAILY_OLD),
        dynamic_name=True,
    ),
    EVNSensorEntityDescription(
        ...
        icon="mdi:cash-multiple",
        native_unit_of_measurement="VNĐ",
        value_fn=lambda data: data.get(ID_ECOST_DAILY_OLD),
        dynamic_name=True,
    ),
    # Current month
    EVNSensorEntityDescription(
        ...
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        value_fn=lambda data: data.get(ID_ECON_MONTHLY_NEW),
    ),
    EVNSensorEntityDescription(
        ...
        icon="mdi:cash-multiple",
        native_unit_of_measurement="VNĐ",
        value_fn=lambda data: data.get(ID_ECOST_MONTHLY_NEW),
    ),
    # Total e-consumption
    EVNSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        value_fn=lambda data: data.get(ID_ECON_TOTAL_NEW),
    ),
    EVNSensorEntityDescription(
        ...
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        value_fn=lambda data: data.get(ID_ECON_TOTAL_OLD),
    ),
    # Dates
    EVNSensorEntityDescription(
        key=ID_TO_DATE,
        ...
        value_fn=lambda data: data.get(ID_TO_DATE),
    ),
    EVNSensorEntityDescription(
        key=ID_FROM_DATE,
        name="Ngày đầu kì",
        icon="mdi:calendar-clock",
        value_fn=lambda data: data.get(ID_FROM_DATE),
    ),
    EVNSensorEntityDescription(
        ...
        value_fn=lambda data: data.get(ID_LATEST_UPDATE),
    ),
    # Previous bill
    EVNSensorEntityDescription(
        ...
        value_fn=lambda data: data.get(ID_PAYMENT_NEEDED),
        dynamic_icon=True,
    ),
    EVNSensorEntityDescription(
        ...
        icon="mdi:cash-multiple",
        native_unit_of_measurement="VNĐ",
        value_fn=lambda data: data.get(ID_M_PAYMENT_NEEDED),
        dynamic_icon=True,
    ),
    EVNSensorEntityDescription(
        key=ID_LOADSHEDDING,
        ...
        value_fn=lambda data: data.get(ID_LOADSHEDDING),
        dynamic_icon=True,
    ),
)
